...
- [Prompts for TOPIC CREATION using ChatGPT](#prompts-for-topic-creation-using-chatgpt)
  ...
  - [Prompts with PLACEHOLDERS for PROGRAMMING LANGUAGE topics](#prompts-with-placeholders-for-programming-language-topics)
    ...
    - [Instruct ChatGPT to review the theory on its own — ⚠️ NOT 100% RELIABLE ⚠️](#instruct-chatgpt-to-review-the-theory-on-its-own--%EF%B8%8F-not-100-reliable-%EF%B8%8F)
...
 
### Instruct ChatGPT to review the theory on its own — ⚠️ NOT 100% RELIABLE ⚠️
